...
import { MessageInterface as Message } from '../../../common/interfaces/message.interface.ts';
		...
		<div className="chat-container">
			...
			<div className="chat-messages">
				<div className="grid grid-cols-12 gap-y-2">
					{/* Bienvenida */}
					<GptMessage text="You can input whatever you want to compare and it'll give you my point of views." />
